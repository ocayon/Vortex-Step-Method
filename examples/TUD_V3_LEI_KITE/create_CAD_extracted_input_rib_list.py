...
save_path = (
    ...
    / "processed_data"
    / "TUD_V3_LEI_KITE"
    / "CAD_extracted_input_rib_list_lei_airfoil_breukels.pkl"
)
...
save_path = (
    ...
    / "processed_data"
    / "TUD_V3_LEI_KITE"
    / "CAD_extracted_input_rib_list_polar_data.pkl"
)
with open(save_path, "wb") as file:
